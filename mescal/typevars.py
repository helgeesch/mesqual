...
if TYPE_CHECKING:
    ...
    from mescal.visualizations.value_mapping_system.continuous import SegmentedContinuousInputToContinuousOutputMapping
...
ContinuousMappingType = TypeVar('ContinuousMappingType', bound='SegmentedContinuousInputToContinuousOutputMapping')

...
from mescal.utils.color_utils.conversion import to_hex  # Ensure this exists
    ...
    def _create_html_components(self):
        ...
        for (start, end), colors in self.sorted_segments:
            ...
            if len(color_list) == 1:
                ...
                stops = [f"{color} {100 * i / (len(color_list) - 1):.2f}%"
        ...
        # Generate ticks with n_ticks_per_segment per segment
        all_ticks = []

...
This package provides utilities for working with Plotly figures in the MESQUAL framework,
including:
...
Example:
    ...
    >>> from mesqual.utils.plotly_utils import PlotlyTheme, figure_utils
